...
function Venue() {
  ...
  useEffect(() => {
    document.title =
      "Συνεδριακό Κέντρο | 53ο Πανελλήνιο Συνέδριο Εθνικού Συνδέσμου Νοσηλευτών Ελλάδος 6-9 Μαΐου 2026, Κεφαλονιά";
    return () => {
      document.title =
        "53ο Πανελλήνιο Συνέδριο Εθνικού Συνδέσμου Νοσηλευτών Ελλάδος"; // Reset on unmount
    };
  }, []);
  const { data, loading, error } = FetchDataForComponents("/data/venue.json");
