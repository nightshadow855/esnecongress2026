...
class MiniGl {
  constructor(canvas, width, height, debug = false) {
    ...
    ((_miniGl.canvas = canvas),
      ...
      (_miniGl.meshes = []),
      (_miniGl.isSupported = !!_miniGl.gl));
    ...
    if (!context) {
      console.warn(
        "WebGL context unavailable. Gradient animation is disabled.",
      );
      return;
    }
...
class Gradient {
  constructor(...t) {
    (e(this, "el", void 0),
      ...
      e(this, "resize", () => {
        if (!this.minigl?.gl || !this.mesh) return;
      ...
      e(this, "initGradient", (selector) => {
        ...
        if (!this.el) {
          ...
          console.warn(`Gradient canvas not found for selector: ${selector}`);
          return this;
        }
        this.connect();
        return this;
        ...
        : ((this.minigl = new MiniGl(this.el, null, null, !0)),
          this.minigl?.gl
            ...
            : ((this.isWebGlSupported = false),
              (this.conf.playing = false),
              console.warn(
                "Gradient disabled because WebGL context could not be created.",
              )),
