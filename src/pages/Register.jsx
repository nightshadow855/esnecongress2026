...
import RegistrationCards from "@/components/ui/RegistrationCards";

function Agenda() {
  //set the title of the page
  useEffect(() => {
    document.title =
      "Εγγραφή | 53ο Πανελλήνιο Συνέδριο Εθνικού Συνδέσμου Νοσηλευτών Ελλάδος 6-9 Μαΐου 2026, Κεφαλονιά";
    return () => {
      document.title =
